Party Agent Mobile Application
Purpose

The Party Agent mobile application allows party agents to receive assignments, report election activities, communicate with coordinators, and submit information from their assigned polling units.

1. Login
Purpose

Allows the Party Agent to securely access the mobile application.

Features
Login using Phone Number/Username and Password
Forgot Password
Change Password
Logout
Remember Login (Optional)
2. Assigned Polling Unit
Purpose

Shows the polling unit assigned to the agent.
...
Features
View polling unit details
View coordinator information
3. Upload Observations
Purpose

Allows the agent to submit observations during the election.

Features
Create Observation
Edit Observation (Before Submission)
Delete Draft
Submit Observation
...
Allows the agent to upload photos that support their observations.

Features
Take Photo
Upload Photo
Delete Photo (Before Submission)
...
Allows the agent to report problems during the election.

Features
Create Incident
Edit Incident (Before Submission)
Delete Draft
Submit Incident
...
Allows the agent to communicate with their coordinator.
...
Keeps the agent informed about important updates.
...
Displays the agent's personal information.
...
Logout
Bottom Navigation
Home | Observation | Incidents | Chat | Profile
