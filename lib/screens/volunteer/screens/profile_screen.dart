...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _saveProfile() async {
    ...
    final result = await VolunteerService.updateProfile({
  ...
  Future<void> _changePassword() async {
    ...
    final result = await VolunteerService.changePassword({
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          'Volunteer ID: ${user?.userCode ?? 'N/A'}',
                          style: TextStyle(
                            fontSize: 14,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_isEditing) ...[
                            ...
                            const Divider(),
                            _buildInfoRow('Assigned Area', 'Kangire, Birnin Kudu'),
                            const Divider(),
                            _buildInfoRow('Coordinator', user?.tenantName ?? 'Not Assigned'),
                          ],
                        ],
                      ),
                    ),
